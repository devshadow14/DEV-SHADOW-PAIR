...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Animation de fond matrix verte */
        .matrix-bg {
            position: absolute;
            top: 0;
            left: 0;
        ...
        @keyframes fall {
            0% { transform: translateY(-100px); opacity: 0.15; }
        ...
        /* === BOUTON HACKER AVEC EFFET EAU QUI CLIGNOTE === */
        button {
            width: 100%;
            padding: 18px;
            background: #003300;  /* vert foncé */
            color: #0f0;
            ...
            animation: waterBlink 1.2s infinite ease-in-out;
        }
        
        /* Vague d'eau animée à l'intérieur du bouton */
        button::after {
            content: '';
            position: absolute;
            top: 0;
            ...
            background: repeating-linear-gradient(
                ...
                rgba(0, 200, 255, 0.2) 20px,
                rgba(0, 200, 255, 0.2) 30px
            );
        ...
        @keyframes waterWave {
            0% { left: -100%; background-position: 0% 50%; }
            100% { left: 100%; background-position: 100% 50%; }
        }
        
        /* Clignotement vert / cyan */
        @keyframes waterBlink {
            0% { box-shadow: 0 0 5px #0f0, inset 0 0 5px #0f0; text-shadow: 0 0 2px #0f0; }
            50% { box-shadow: 0 0 20px #0f0, inset 0 0 15px #0f0; text-shadow: 0 0 8px #0f0; background-color: #0a3a0a; border-color: #0ff; }
            100% { box-shadow: 0 0 5px #0f0, inset 0 0 5px #0f0; text-shadow: 0 0 2px #0f0; }
        }
        
        button:hover {
            transform: translateY(-3px);
            animation: waterBlink 0.6s infinite;
        }

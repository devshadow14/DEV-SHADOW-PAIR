    ...
    dvmsy.ev.on("connection.update", async (update) => {
        ...
        if (connection === "close") {
            ...
            await dvmsy.sendMessage(userJid, {
                image: { url: "maria.png" },
                caption: `╭───────────────⭓\n│ ✅ *𝙼𝙸𝙽𝙸 𝙳𝙴𝚅 𝚂𝙷𝙰𝙳𝙾𝚆 𝙼𝙳 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴́*\n├───────────────\n│ 👤 *User:* ${dvmsy.user.name || 'Bot'}\n│ 🛠️ *Autoload:* Success\n│ 🔥 *Auto-React:* Charnel\n│ 👀 *Auto-Status:* Active\n╰───────────────⭓\n\n> 𝚙𝚘𝚠𝚛𝚎𝚍 𝚋𝚢 𝙳𝙴𝚅 𝚂𝙷𝙰𝙳𝙾𝚆 𝙼𝙳 ϟ`,
            });
        }
    });
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Animation de fond - STYLE HACKER (vert) */
        .matrix-bg {
            position: absolute;
            top: 0;
            left: 0;
        ...
        /* BOUTON EAU - BLEU CLIQUOTANT À L'INTÉRIEUR */
        @keyframes clignotementBleu {
            0% { box-shadow: 0 0 5px #0066ff, inset 0 0 5px #0066ff; background: linear-gradient(45deg, #0066ff, #0033cc); }
            50% { box-shadow: 0 0 20px #0099ff, inset 0 0 15px #0099ff; background: linear-gradient(45deg, #3399ff, #0066cc); }
            100% { box-shadow: 0 0 5px #0066ff, inset 0 0 5px #0066ff; background: linear-gradient(45deg, #0066ff, #0033cc); }
        }
        ...
        button {
            ...
            position: relative;
            overflow: hidden;
            animation: clignotementBleu 1s infinite;
        }
...
<body>
    ...
    <div class="container">
        <div class="box">
            <h1>𝙼𝙸𝙽𝙸 𝙱𝙾𝚃 𝙳𝙴𝚅 𝚂𝙷𝙰𝙳𝙾𝚆</h1>
            <div class="subtitle">POWRED BY DEV SHADOW TECH🇸🇳</div>
...
app.listen(port, async () => {
    console.log(`🌐 DEV SHADOW prêt sur : http://84.247.177.39:${port}`);
